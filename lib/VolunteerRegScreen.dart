...
class _VolunteerRegScreenState extends State<VolunteerRegScreen>
  ...
  void initState() {
    ...
    _color1 = ColorTween(begin: const Color(0xFF0B0211), end: const Color(0xFF2E0249))
        .animate(_controller);
    _color2 = ColorTween(begin: const Color(0xFF8000FF), end: const Color(0xFF570A57))
        .animate(_controller);
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SlideInLeft(
                              ...
                              child: _buildTextField(
                                ...
                                validator: (v) {
                                  ...
                                  if (!RegExp(r'^[0-9]{10,15}$').hasMatch(v)) return "Enter valid Phone Number";
                                  return null;
                                },
                              ),
                            ),
                            ...
                            SlideInLeft(
                              ...
                              child: Row(
                                children: [
                                  const Text('Gender:', style: TextStyle(color: Colors.white70, fontWeight: FontWeight.bold)),
                                  Radio<String>(value: 'Male', groupValue: gender, onChanged: (val) => setState(() => gender = val), activeColor: const Color(0xFF9D4EDD)),
                                  const Text('Male', style: TextStyle(color: Colors.white70)),
                                  Radio<String>(value: 'Female', groupValue: gender, onChanged: (val) => setState(() => gender = val), activeColor: const Color(0xFF9D4EDD)),
                            ...
                            SlideInUp(
                              ...
                              child: AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  gradient: const LinearGradient(colors: [Color(0xFF8000FF), Color(0xFF570A57)]),
                                  boxShadow: [BoxShadow(color: Color(0xFF8000FF).withOpacity(0.5), blurRadius: 20, spreadRadius: 1)],
                                ),
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(15),
          borderSide: BorderSide(color: const Color(0xFF9D4EDD).withOpacity(0.3)),
        ),
